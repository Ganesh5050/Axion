...
import { ArrowRight, Calculator, BarChart2, FileSpreadsheet } from "lucide-react";
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mx-auto text-center space-y-8 animate-fade-in">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Model scenarios and benchmark financials
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="bg-card border border-border rounded-lg p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Build sophisticated financial models with automated data enrichment. Create scenarios and run what-if analysis at scale.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Model multiple scenarios with real-time data. Analyze outcomes and make data-driven financial decisions with confidence.
              </p>
            </div>
            ...
            <div className="bg-card border border-border rounded-lg p-8">
              ...
              <h3 className="text-xl font-semibold mb-3">Benchmark Analysis</h3>
              <p className="text-muted-foreground leading-relaxed">
                Compare financial metrics across companies and industries. Build comprehensive benchmark databases automatically.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Join finance teams using Axion for faster, more accurate analysis
            </p>
